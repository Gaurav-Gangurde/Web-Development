...
//   return count;
// };
//   console.log(checkAllVowelPresentOrNot("my name u is Gaurav @  Gangurde"));
...
let result3 = text.replace("JavaScript", "Gaurav");
let result4 = text.replaceAll("JavaScript", "Gaurav");
